...
public class Kamcord : MonoBehaviour
{
	...
	public bool enableKamcord = true;
	...
	private static bool kamcordEnabled_ = true;
	...
	private static Implementation implementation()
	{
		...
		{
			if (kamcordEnabled_ && (Application.platform == RuntimePlatform.Android || Application.platform == RuntimePlatform.IPhonePlayer))
			{
	...
	public static void _kamcordViewDidAppear()
	{
