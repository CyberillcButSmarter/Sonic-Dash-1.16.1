...
public class GameplayTemplate : IEnumerable, IEnumerable<GameplayTemplate.Row>
{
	...
	public class Cell
	{
		...
		public bool HasEntities
		{
			get
			{
				return LowEntity.IsValid || HighEntity.IsValid;
			}
		}
	...
	[Serializable]
	public class Row : IEnumerable, IEnumerable<Cell>
	{
		...
		public bool IsFullGap
		{
			get
			{
				return IsGapInLane(Lane.Left) && IsGapInLane(Lane.Middle) && IsGapInLane(Lane.Right);
			}
		}
		...
		public bool IsEmptyAir
		{
			get
			{
				return m_gapRowType != GapRowType.None;
			}
		}
		...
		public bool IsEventRow
		{
			get
			{
				return IsEmptyAir || IsFullGap;
			}
		}

		public Cell this[Lane lane]
		{
			get
			{
				return m_cells[(int)lane];
			}
		}

		public IEnumerable<Cell> CharacterLanesOnly
		{
			get
			{
				return this.Skip(1).Take(3);
			}
		}
	...
	public IEnumerable<Group> GroupIDs
	{
		get
		{
			return m_groupIDs;
	...
	public bool HasFishLanes
	{
		get
		{
			return this.Any((Row row) => row.LaneHasEntities(Lane.LeftFish) || row.LaneHasEntities(Lane.RightFish));
		}
	}
	...
	{
		uint num = requestedGameplay & 0x2F8;
	...
	private void CalculateIsMultiLanePossible(Entity left, Entity middle, Entity right)
	{
		...
		{
			bool flag = (right.IsPossiblyMultiLane = true);
			flag = (left.IsPossiblyMultiLane = flag);
			middle.IsPossiblyMultiLane = flag;
		}
	}
