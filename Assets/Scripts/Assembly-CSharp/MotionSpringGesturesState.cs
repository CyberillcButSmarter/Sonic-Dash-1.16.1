...
public class MotionSpringGesturesState : MotionSpringState
{
	...
	private CartesianDir CurrentWindowGesture
	{
		get
		{
			return m_windowInputsRequired[m_completedGestureWindows];
		}
	}
	...
	{
		CartesianDir dir = ((direction != SideDirection.Left) ? CartesianDir.Right : CartesianDir.Left);
		OnGestureInput(dir);
		return null;
	}
