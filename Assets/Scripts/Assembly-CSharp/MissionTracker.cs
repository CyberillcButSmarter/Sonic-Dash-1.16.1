...
public class MissionTracker : MonoBehaviour
{
	...
	{
		AvoidRings_Distance = 0,
		BankInOneRun_Rings = 1,
		VisitsTemple_Times = 2,
		CollectInOneRun_Rings = 3,
		SpendInStore_Rings = 4,
		CollectMoreInOneRun_Rings = 5,
		TripOnMines_Times = 6,
		UseRevive_Times = 7,
		UseHeadstarts_Times = 8,
		RunInOneRun_Distance = 9,
		_2_CompleteDC_Times = 10,
		_2_PickUpInOneRun_Shields = 11,
		_2_BankInOneRun_Rings = 12,
		_2_UseSuperHeadstarts_Times = 13,
		_2_SpendInStore_Rings = 14,
		_2_InOneRun_EnemyStreaks = 15,
		_2_RunInOneRun_Distance = 16,
		_2_CollectInOneRun_Rings = 17,
		_2_DashBoostThroughTotemsInOneRun_Times = 18,
		_2_UseReviveInOneRun_Times = 19
	}

	public enum MissionLevel2
	{
		RollUnderBridge_Times = 0,
		InOneRun_EnemyStreaks = 1,
		ScoreInOneRun_Points = 2,
		Run_Distance = 3,
		ScoreWithoutDroppingRingsInOneRun_Points = 4,
		RollMiddleLane_Times = 5,
		InOneRun_RingStreaks = 6,
		DropWithoutDying_Rings = 7,
		RunWithoutBankingInOneRun_Distance = 8,
		PickUpInOneRun_PowerUps = 9,
		_2_RunWithFullDashMeterInOneRun_Distance = 10,
		_2_SpendAirbourneInOneRun_Seconds = 11,
		_2_JumpOverCrabmeatsInOneRun_Times = 12,
		_2_ScoreInOneRun_Points = 13,
		_2_RemainInSameLineInOneRun_Distance = 14,
		_2_TripOnMinesInOneRun_Times = 15,
		_2_UseDashInOneRun_Times = 16,
		_2_RollUnderBridgeInOneRun_Times = 17,
		_2_RunWithoutBankingInOneRun_Distance = 18,
		_2_ScoreWithoutDroppingRingsInOneRun_Points = 19
	}

	public enum MissionLevel3
	{
		UseDash_Times = 0,
		PlayForConsecutive_Days = 1,
		RunCorkscrews_Times = 2,
		DefeatNonBoss_Enemies = 3,
		RunLoops_Times = 4,
		DefeatUsingHoming_Enemies = 5,
		Total_EnemyStreaks = 6,
		Total_RingStreaks = 7,
		DefeatUsingHoming_Enemies2 = 8,
		UpgradeToMax_PowerUps = 9,
		_2_Run_Distance = 10,
		_2_DashBoostThroughTotems_Times = 11,
		_2_Total_RingStreaks = 12,
		_2_JumpOverPlantPots_Times = 13,
		_2_UpgradeToMax_PowerUps = 14,
		_2_PickUp_PowerUps = 15,
		_2_RunWithFullDashMeter_Distance = 16,
		_2_SpendAirbourne_Seconds = 17,
		_2_JumpOverSpikys_Times = 18,
		_2_CompleteDCConsecutiveDays_Times = 19
	}
	...
	public static int RSRRewardPerSet { get; private set; }
	...
	{
		s_missionTracker.CompleteMission(ref s_missionTracker.m_missions[missionGroup][s_missionTracker.m_missionSets[missionGroup][s_missionTracker.m_currentMissionSet]], true);
	}
	...
	public static void GetMissionDescription(int level, UILabel targetLabel)
	{
		Mission activeMission = GetActiveMission(level);
		MissionAssets.Assets missionAssets = GetMissionAssets(level);
		LocalisedStringProperties component = targetLabel.GetComponent<LocalisedStringProperties>();
	...
	public static MissionAssets.Assets GetMissionAssets(int level)
	{
		...
		int translatedIndex = GetTranslatedIndex(level);
	...
	private void Update()
	{
		...
		for (int i = 0; i < m_missions.Length; i++)
		{
			...
			else if (GameState.GetMode() != GameState.Mode.Menu && (currentMission.m_state & Mission.State.Completed) != Mission.State.Completed)
			{
				CheckMission(ref currentMission);
			}
	...
	private void CheckMission(ref Mission currentMission)
	{
		...
		case PlayerStats.StatTypes.Int:
			...
			{
				CompleteMission(ref currentMission, false);
			}
			break;
	...
	private void CreateMissions()
	{
		...
		m_missions[0][1].m_trackedValue = 17;
		...
		m_missions[0][2].m_trackedValue = 36;
		...
		m_missions[0][3].m_trackedValue = 12;
		...
		m_missions[0][4].m_trackedValue = 22;
		...
		m_missions[0][5].m_trackedValue = 12;
		...
		m_missions[0][6].m_trackedValue = 26;
		...
		m_missions[0][7].m_trackedValue = 48;
		...
		m_missions[0][8].m_trackedValue = 51;
		...
		m_missions[0][10].m_trackedValue = 82;
		...
		m_missions[0][11].m_trackedValue = 42;
		...
		m_missions[0][12].m_trackedValue = 17;
		...
		m_missions[0][13].m_trackedValue = 54;
		...
		m_missions[0][14].m_trackedValue = 22;
		...
		m_missions[0][17].m_trackedValue = 12;
		...
		m_missions[0][18].m_trackedValue = 88;
		...
		m_missions[0][19].m_trackedValue = 50;
		...
		m_missions[1][0].m_trackedValue = 29;
		...
		m_missions[1][5].m_trackedValue = 28;
		...
		m_missions[1][6].m_trackedValue = 20;
		...
		m_missions[1][7].m_trackedValue = 23;
		...
		m_missions[1][9].m_trackedValue = 43;
		...
		m_missions[1][11].m_trackedValue = 90;
		...
		m_missions[1][12].m_trackedValue = 84;
		...
		m_missions[1][15].m_trackedValue = 27;
		...
		m_missions[1][16].m_trackedValue = 35;
		...
		m_missions[1][17].m_trackedValue = 30;
		...
		m_missions[2][0].m_trackedValue = 33;
		...
		m_missions[2][2].m_trackedValue = 31;
		...
		m_missions[2][3].m_trackedValue = 2;
		...
		m_missions[2][4].m_trackedValue = 32;
		...
		m_missions[2][7].m_trackedValue = 19;
		...
		m_missions[2][8].m_trackedValue = 5;
		...
		m_missions[2][9].m_trackedValue = 47;
		...
		m_missions[2][11].m_trackedValue = 87;
		...
		m_missions[2][12].m_trackedValue = 19;
		...
		m_missions[2][13].m_trackedValue = 86;
		...
		m_missions[2][14].m_trackedValue = 47;
		...
		m_missions[2][15].m_trackedValue = 43;
		...
		m_missions[2][17].m_trackedValue = 89;
		...
		m_missions[2][18].m_trackedValue = 85;
		...
		m_missions[2][19].m_trackedValue = 83;
	...
	private void Event_OnGameDataLoaded(ActiveProperties activeProperties)
	{
		...
		if ((mission.m_id == 3 || mission.m_id == 5 || mission.m_id == 8) && mission.m_amountTarget - mission.m_amountStart != mission.m_amountNeeded)
		{
			PlayerStats.Stats currentStats = PlayerStats.GetCurrentStats();
			long num = mission.m_amountCurrent - mission.m_amountStart;
			mission.m_amountCurrent = currentStats.m_trackedStats[mission.m_trackedValue];
			mission.m_amountStart = mission.m_amountCurrent - num;
			mission.m_amountTarget = mission.m_amountStart + mission.m_amountNeeded;
		}
	...
	private Mission[] GetCurrentSet()
	{
		...
		for (int i = 0; i < m_missions.Length; i++)
		{
			array[i] = m_missions[i][m_missionSets[i][m_currentMissionSet]];
		}
		return array;
	}
	...
	{
		int testValueAsInt = ABTesting.GetTestValueAsInt(ABTesting.Tests.RSR_MissionSetAmount);
		if (testValueAsInt != -1)
		{
			RSRRewardPerSet = testValueAsInt;
		}
	}
}
