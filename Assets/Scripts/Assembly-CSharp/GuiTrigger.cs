...
public class GuiTrigger : MonoBehaviour
{
	...
	public Transform CharacterStandPoint
	{
		get
		{
			return m_characterStandPoint;
		}
	}
	...
	public bool Visible
	{
		get
		{
			return (m_state & State.Visible) == State.Visible;
		}
	}
	...
	public bool Transition
	{
		get
		{
			return (m_state & State.TransitionDisabled) == State.TransitionDisabled;
		}
	}
	...
	private void InitialiseContent()
	{
		...
		m_buttonList = uIPanel.GetComponentsInChildren<BoxCollider>(true);
		if (m_buttonList != null && m_buttonList.Length > 0)
		{
