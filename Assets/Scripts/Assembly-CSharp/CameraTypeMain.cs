...
public class CameraTypeMain : CameraType
{
	...
	private bool m_hasOneTimeOffset;

	private Vector3 m_vOneTimeOffset = Vector3.zero;
	...
	public void SetOneTimeOffset(Vector3 vOffset)
	{
		m_hasOneTimeOffset = true;
		m_vOneTimeOffset = vOffset;
	}
	...
	private void TrackTargetCamera()
	{
		...
		if (m_hasOneTimeOffset)
		{
			vector += m_vOneTimeOffset;
			vector2 += m_vOneTimeOffset;
			m_hasOneTimeOffset = false;
		}
	...
	public int GetCullingMask()
	{
		...
		{
			return m_thisCamera.cullingMask;
		}
		return 0;
	}
	...
	{
		return (m_cameraToTrack != null && m_cameraToTrack.GetType() == typeof(CameraTypeSpline)) || (m_previousCameraToTrack != null && m_previousCameraToTrack.GetType() == typeof(CameraTypeSpline));
	}
}
