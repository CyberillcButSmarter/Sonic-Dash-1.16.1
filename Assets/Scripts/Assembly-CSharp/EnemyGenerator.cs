...
public class EnemyGenerator : HazardGenerator
{
	...
	private Enemy GetNearestGoldenEnemy(float lowestDistance)
	{
		...
		Component[] componentsInChildren = m_trackGen.GetComponentsInChildren<Enemy>(true);
	...
	private void Event_OnNewGameStarted()
	{
		...
		goldnikAura.gameObject.SetActive(true);
	...
	private void Update()
	{
		...
		goldnikAura.gameObject.GetComponent<Renderer>().enabled = true;
