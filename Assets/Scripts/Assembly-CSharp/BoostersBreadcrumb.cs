...
public class BoostersBreadcrumb : MonoBehaviour
{
	...
	private static string CurrentBreadcrumbSaveProperty
	{
		get
		{
			return "BoostersCurrentBreadcrumb";
		}
	}

	private static string BreadcrumbShownSaveProperty
	{
		get
		{
			return "BoostersBreadcrumbShown";
		}
	}

	private static string AnnouncementShownSaveProperty
	{
		get
		{
			return "BoosterAnnouncementShown";
		}
	}
	...
	private void Event_OnGameDataLoaded(ActiveProperties activeProperties)
	{
		...
		string text = activeProperties.GetString("BoostersBreadcrumbShown");
		if (text != null)
		{
