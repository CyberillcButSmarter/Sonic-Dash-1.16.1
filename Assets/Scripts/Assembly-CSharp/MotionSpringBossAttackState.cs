...
public class MotionSpringBossAttackState : MotionSpringState
{
	...
	{
		BossBattleSystem.GestureSettings.Types gesture = ((direction != SideDirection.Left) ? BossBattleSystem.GestureSettings.Types.Right : BossBattleSystem.GestureSettings.Types.Left);
