...
public class TrackDatabase : MonoBehaviour
{
	...
	public class ZoneInfo
	{
		...
		public List<SubzoneInfo> Subzones
		{
			get
			{
				return m_subzones;
		...
		public SubzoneInfo this[int subzoneIndex]
		{
			get
			{
				return m_subzones[subzoneIndex];
			}
		}
	}
	...
	public IEnumerable<ZoneInfo> Zones
	{
		get
		{
			return m_zones;
	...
	public TrackPiecePrefab SubzoneTransitionPrefab
	{
		get
		{
			return m_subzoneTransitionPrefab;
		}
	}

	public IEnumerable<TrackPiece> TrackPieces
	{
		get
		{
			return m_trackPieces;
		}
	}
	...
	public int SubzoneIndex
	{
		get
		{
			return m_subzoneIndex;
		}
	}

	public List<TrackPiecePrefab> SubzonePrefabs
	{
		get
		{
			return m_subzonePrefabs;
		}
	}
