...
public class Difficulty : MonoBehaviour
{
	...
	public static bool IsAvaliable
	{
		get
		{
			return s_difficulty != null && Sonic.Tracker != null;
		}
	}

	public static bool IsSonicDifficultyAvailable
	{
		get
		{
			return IsAvaliable && (Sonic.Tracker.CurrentSpline != null || Sonic.Tracker.Track != null);
		}
	}
	...
	private void StoreRunDistance()
	{
		...
		if (m_lastRunsDistances[0] > 500f)
		{
			SLAnalytics.LogPushTagWithParameters("Reached 500", "1", "string");
		}
	}
