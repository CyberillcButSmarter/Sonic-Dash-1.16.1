...
public class GCCollectableGenerator : MonoBehaviour
{
	...
	public static int NumCollectables
	{
		get
		{
			return s_singleton.m_numCollectables;
		}
	}
	...
	public static bool CanSpawnGCCollectable(float distance)
	{
		...
		if (false || !GCState.IsCurrentChallengeActive() || GC6Progress.ChallengeFullycompleted())
		{
			return false;
		}
		int num = GC6Progress.CurrentCollectedThisRun + s_singleton.m_spawnedThisTrack;
		if (num >= GC6Progress.GetLocalTierSize - 1)
		{
			return false;
		}
