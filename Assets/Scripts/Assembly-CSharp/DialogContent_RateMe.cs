...
public class DialogContent_RateMe : MonoBehaviour
{
	...
	public static DialogContent_RateMe Instance
	{
		get
		{
			return s_instance;
	...
	private void Event_OnGameDataSaveRequest()
	{
		...
		PropertyStore.Store("RateMeVersion", "1.16.1");
	...
	private void Event_OnGameDataLoaded(ActiveProperties activeProperties)
	{
		...
		{
			m_canShow = activeProperties.GetInt("RateMeCanShow") > 0 || text != "1.16.1";
		}
