...
public class BundleGui : MonoBehaviour
{
	...
	{
		float value = Mathf.Clamp(progress, 0f, 1f);
		m_bundleDownloadProgress.value = value;
	}
	...
	{
		TweenAlpha[] componentsInChildren = rootObject.GetComponentsInChildren<TweenAlpha>(true);
