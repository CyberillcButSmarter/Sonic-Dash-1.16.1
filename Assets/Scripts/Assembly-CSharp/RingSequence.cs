...
public class RingSequence : IEnumerable
{
	...
	public bool RingsCollected
	{
		get
		{
			return (m_state & State.RingCollected) == State.RingCollected;
		}
	}

	public bool StreakCompleted
	{
		get
		{
			return (m_state & State.StreakCompleted) == State.StreakCompleted;
		}
	}

	public bool StreakMissed
	{
		get
		{
			return (m_state & State.StreakMissed) == State.StreakMissed;
		}
	}
	...
	public bool Reserved
	{
		get
		{
			return (m_state & State.Reserved) == State.Reserved;
		}
	}
	...
	public bool IsIdleGameplaySequence
	{
		get
		{
			return !Reserved && !RingsAvailable;
		}
	}

	public bool IsSequencePositionSupported
	{
		get
		{
			return !Reserved;
	...
	public Vector3 WorldLocalSequencePosition
	{
		get
		{
			return m_cachedLocalSequencePosition;
		}
	}

	public float SqSequenceRadius
	{
		get
		{
			return m_cachedSequenceSqRadius;
		}
	}
