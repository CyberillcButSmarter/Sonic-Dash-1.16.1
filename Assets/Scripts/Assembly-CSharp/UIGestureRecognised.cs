...
public class UIGestureRecognised : MonoBehaviour
{
	...
	public void Strafe(SideDirection direction)
	{
		...
		{
			ApplyText(string.Format("Gesture: Strafe Left"));
		}
		else
		{
			ApplyText(string.Format("Gesture: Strafe Right"));
		}
	}

	public void Roll()
	{
		ApplyText(string.Format("Gesture: Roll"));
	}

	public void Dive()
	{
		ApplyText(string.Format("Gesture: Dive"));
	}

	public void Jump()
	{
		ApplyText(string.Format("Gesture: Jump"));
	}

	public void Tap(float[] array)
	{
		ApplyText(string.Format("Gesture: Tap"));
	}
}
