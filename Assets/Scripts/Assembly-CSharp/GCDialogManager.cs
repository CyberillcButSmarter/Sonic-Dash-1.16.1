...
public class GCDialogManager : MonoBehaviour
{
	...
	{
		if (GCState.ChallengeState(GCState.Challenges.gc6) != GCState.State.Active)
		{
			return false;
		}
	...
	public static void ShowChallengeActiveDialog()
	{
		...
		s_singleton.m_shownActiveDialog[1] = true;
		s_singleton.m_gcLiveDialogShownState = s_singleton.m_shownActiveDialog[0] + "," + 5;
		PropertyStore.Save();
	}
	...
	public static void ShowChallengeInvolvementDialog()
	{
		...
		s_singleton.m_shownInvolvementDialog[1] = true;
		s_singleton.m_gcInvolvementDialogShownState = s_singleton.m_shownInvolvementDialog[0] + "," + 5;
		PropertyStore.Save();
	}
	...
	public static bool ShouldShowFirstTimeVisitDialog()
	{
		...
		if (GC6Progress.CurrentCollectedThisRun == 0)
		{
			return false;
		}
	...
	public static void ShowFirstTimeVisitDialog()
	{
		...
		s_singleton.m_shownFirstTimeVisitDialog[1] = true;
		s_singleton.m_gcFirstTimeVisitDialogShownState = s_singleton.m_shownFirstTimeVisitDialog[0] + "," + 5;
		PropertyStore.Save();
	}
	...
	private void Event_OnGameDataLoaded(ActiveProperties ap)
	{
		...
		{
			m_gcLiveDialogShownState = "False," + 5;
		}
		...
		{
			m_gcInvolvementDialogShownState = "False," + 5;
		}
		...
		{
			m_gcFirstTimeVisitDialogShownState = "False," + 5;
		}
	}
}
